        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i; i < length; i++) {
                    ...
                    $("#v_tbody").append("<tr class='odd gradeX'><td class='sorting_1'><input type='checkbox' name='vcid' class='checkboxes' value='" + vcid + "'></td><td>" + i_ + "</td><td>admin</td><td class='hidden-480'>2017-07-25 15:01:29</td><td class='hidden-480'><span class='label label-success'>正常</span></td><td class='hidden-480'>登录系统成功</td></tr>")
